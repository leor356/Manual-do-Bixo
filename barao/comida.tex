...
Um dos momentos de glória do dia de qualquer futur* engenheir*, cientista ou bacharel
...
assim como muit*s dizem. Sem dúvida, é o melhor custo-benefício da Unicamp. Por
...
mais lugares e a localização o torna muito prático para *s computeir*s. Porém,
...
da manhã, atendendo a uma demanda d*s estudantes. De acordo com o reitor Tadeu
...
Os cálculos ainda não foram fechados, mas cada usuário deverá pagar em torno de
...
\begin{itemize}
    ...
    \item   \textbf{Mega Sandubão:} 
      ...
      lanchonete pela famosa maionese temperada que eles servem, não
    ...
    \item   \textbf{Marambar:} Possui bebidas, lanches, sucos e porções a preços
        ...
        Bastante frequentado por computeir*s e engenheiros em geral, além de
